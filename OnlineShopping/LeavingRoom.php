...
createDynamicHTMLTable("Sofas", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=1 group by Product_ID  limit 5  " , $link);
createDynamicHTMLTable("Chairs", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=2 group by Product_ID  limit 5  " , $link);
createDynamicHTMLTable("Loveseats", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=3 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Entertainment Units", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=4 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Recliner", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=5 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Ottomans", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=6 group by Product_ID  limit 5  " , $link);
mysql_close($link);
