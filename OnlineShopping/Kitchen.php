...
createDynamicHTMLTable("Kitchen Cart", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=13 group by Product_ID  limit 5  " , $link);
createDynamicHTMLTable("Shelves", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=14 group by Product_ID  limit 5  " , $link);
createDynamicHTMLTable("Pot Racks", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=15 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Step tools", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=16 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Cabinets", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=17 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Kitchen Islands", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=18 group by Product_ID  limit 5  " , $link);
mysql_close($link);
