...
createDynamicHTMLTable("Dining Tables", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=19 group by Product_ID  limit 5  " , $link);
createDynamicHTMLTable("Dining Chairs", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=20 group by Product_ID  limit 5  " , $link);
createDynamicHTMLTable("Bar Stools", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=21 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Buffets", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=22 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Pub sets", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=23 group by Product_ID  limit 5  " , $link);

createDynamicHTMLTable("Bars", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=24 group by Product_ID  limit 5  " , $link);
mysql_close($link);
