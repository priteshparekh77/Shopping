...
createDynamicHTMLTable("King /Queen Beds", "select Product_ID,Price,Product_Name,Short_Descr,Dtl_Descr,Model,Weight FROM product where sub_categoryid=7 group by Product_ID  limit 5  " , $link);
